...
public class CSV { 
	...
	static HashMap<String, UsuarioTwitter> UsuariosID = new HashMap<String, UsuarioTwitter>();
	static HashMap<String, UsuarioTwitter> UsuariosNick = new HashMap<String, UsuarioTwitter>();
	...
	private static void procesaLineaDatos( ArrayList<Object> datos ) {
		// TODO Cambiar este proceso si se quiere hacer algo con las cabeceras
		numLin++;
		UsuarioTwitter nuevoUser = new UsuarioTwitter((String)datos.get(0), (String)datos.get(1), (ArrayList<String>)datos.get(2),
				(String)datos.get(3),(Long)datos.get(4), (Long)datos.get(5), (String)datos.get(6),
				(Long)datos.get(7), (String)datos.get(8), (ArrayList<String>)datos.get(9));

		UsuariosID.put(nuevoUser.getId(), nuevoUser);
		UsuariosNick.put(nuevoUser.getScreenName(), nuevoUser);
